        ...
        <?php foreach($user as $user) { ?>
          <form class="mb-3" style="width: 400px; margin-left:0px" method="POST" action="index.php?c=user&a=update">
            ...
            <div class="mb-3" style="display: flex;">
              ...
              <input type="text" id="salary" name="salary" value="<?= $user->getSalary(); ?>" readonly>
            </div>
            <div class="mb-3" style="display: flex;">
              <label for="id" style="margin-right:50px">Created_at:</label>
              <input type="text" id="created_at" name="created_at" value="<?= $user->getCreatedAt(); ?>" readonly>
            </div>
            <div class="mb-3" style="display: flex;">
              <label for="id" style="margin-right:40px">Updated_at:</label>
              <input type="text" id="updated_at" name="updated_at" value="<?= $user->getUpdatedAt(); ?>" readonly>
            </div>
            <div>
            <label for="id" style="margin-right:20px">Profile picture:</label>
            <img id="profile_picture" src="<?= $user->getProfilePicture();?>" alt="" width="200">
            </div>
          </form>
        <?php } ?>
      </div>
